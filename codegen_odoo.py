...
#    Copyright (C) 2004-2010 Tiny SPRL (<http://tiny.be>).
#    Este programa es software libre: usted puede redistribuirlo y / o modificarlo
#    bajo los térrminos de la Licencia Pública General Affero GNU como
#    publicada por la Free Software Foundation, bien de la versión 3 de la
#    Licencia, o (a su elección) cualquier versión posterior.
#
#    Este programa se distribuye con la esperanza de que sea útil,
#    pero SIN NINGUNA GARANTIA; ni siquiera la garantía cute;a implicita de
#    COMERCIALIZACION o IDONEIDAD PARA UN PROPOSITO PARTICULAR. Vea el
...
#    Copyright (C) 2004-2010 Tiny SPRL (<http://tiny.be>).
#    Este programa es software libre: usted puede redistribuirlo y / o modificarlo
#    bajo los términos de la Licencia Pública General Affero GNU como
#    publicada por la Free Software Foundation, bien de la versión 3 de la
#    Licencia, o (a su elección) cualquier versión posterior.
#
#    Este programa se distribuye con la esperanza de que sea útil,
#    pero SIN NINGUNA GARANTIA; ni siquiera la garantía implicita de
#    COMERCIALIZACION o IDONEIDAD PARA UN PROPOSITO PARTICULAR. Vea el
#    GNU Affero General Public License para más detalles.
#
#    Debería haber recibido una copia de la Licencia P&uacute;blica General Affero GNU
#    junto con este programa. Si no es así, consulte  <http://www.gnu.org/licenses/>.
#
###############################################################################
...
<body>
<div class="container">
        <h1><a href="https://github.com/jorgescalona">Codegen Odoo ERP</a></h1>
...
dia.register_export ("PyDia Generación de código (Odoo) INCES-Lara v2", "zip", OpenERPRenderer())
